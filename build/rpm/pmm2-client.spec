...
install -m 0660 queries-postgres-user-tables.yml $RPM_BUILD_ROOT/usr/local/percona/pmm2/collectors/custom-queries/postgresql/medium-resolution/
%if 0%{?systemd}
...
%changelog
* Thu Jan 21 2021 Vadim Yalovets <vadim.yalovets@percona.com>
- PMM-7345 Expose metrics for all available databases in PG server.
